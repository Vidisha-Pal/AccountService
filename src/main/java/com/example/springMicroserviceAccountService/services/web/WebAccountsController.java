...
//    }
    ...
    @RequestMapping("/accounts/web")
    public String goHome() {
        return "index";
    }

    @RequestMapping("/accounts/web/{accountNumber}")
    ...
    @RequestMapping("/accounts/web/owner/{text}")
    ...
    @RequestMapping(value = "/accounts/web/search", method = RequestMethod.GET)
    public String searchForm(Model model) {
        model.addAttribute("searchCriteria", new SearchCriteria());
        return "accountSearch";
    }

    @RequestMapping(value = "/accounts/web/dosearch")
